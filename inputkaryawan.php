...
//cek NIK di database
$cek=mysqli_num_rows(mysqli_query($conn, "SELECT nik FROM data_karyawan WHERE nik='$_POST[nik]'"));
if ($cek > 0) {
?>
		<script language="JavaScript">
		alert('NIK sudah dipakai !, silakan diulang kembali');
		document.location='index.php?page=forminputkaryawan';
		</script>
<?php
}
...
<?php
	...
	//Jika Gagal
	echo "Data Pribadi Karyawan Gagal diinput, silakan diulangi.";
	}
